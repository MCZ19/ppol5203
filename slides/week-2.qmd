...
### You need to set up a system to keep track of you work 
...
- Reproducibility is fundamental for any scientific project. 
  ...
  - If your scientific findings cannot the replicated, it is not science, and you will be in trouble
...
Tracking and staging new files: make any changes you want locally on this repo
