...
# Class Website: [https://tiagoventura.github.io/ppol5203/weeks/week-04.html](https://tiagoventura.github.io/ppol5203/weeks/week-04.html)
...
Notice, we have lecture notes for each of these topics! Read them!!

## Importing librarys in Python

::: incremental
-   The beauty of open-sourced programming languages is being able to stand on the shoulders of other colleagues. That's what we do when we import a python library.
...
But we will see some pre-built "generators" that will be useful for us:
