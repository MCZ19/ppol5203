...
-   [Today: we will learn how to build statistical models in Python]{.red}.
    ...
    - Intro do DS II x But important for you to build an foundation of Data Science. 
...
-   models highlight key aspects of our theory.
...
If you go back and forth between training and test to decide which model to use, you might also be over-fitting. This is the idea of data leakage.
