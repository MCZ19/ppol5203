...
## Using statistical models to analyze text?
...
- Reduce Complexity of Text (Think about every work as a variable. This is huge matrix!!)
...
-  To represent documents as numbers, we will use the [vector space model representation]{.red}:
   ...
   -   Each feature $w_i$ can be placed in a real line, then a document $D_i$ is a point with $W$ dimensional space
